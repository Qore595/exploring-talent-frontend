      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure the parameters for hourly margin calculation
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  {Object.entries(ENGAGEMENT_TYPE_CONFIGS)
                    .filter(([key]) => key !== 'w2-salary') // Exclude W2 Salary from hourly calculator
                    .map(([key, config]) => (
                      <SelectItem key={key} value={key}>
                        {config.label}
                      </SelectItem>
            ...
            {/* Company Split (if applicable) */}
            {engagementConfig.allowsSplit && (
              <div>
            ...
            {engagementConfig.requiresEmployerTax && (
              <div>
          ...
          <>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Margin calculation for {engagementConfig.label} candidate
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-4 bg-muted rounded-lg">
                    ...
                    <div className="text-sm text-muted-foreground">Candidate Rate</div>
                  </div>
                  {canViewAllMargins && (
                    <>
                      <div className="text-center p-4 bg-muted rounded-lg">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    {results.breakdown.employerTax > 0 && (
                      <div className="flex justify-between items-center text-red-600">
...
export default HourlyMarginCalculator;
