...
const ContractorMarginCalculator = () => {
  const { user } = useAuth();
  ...
  const [formData, setFormData] = useState<MarginCalculationInput>({
    ...
    companySplitPercent: DEFAULT_VALUES.companySplitPercent,
  ...
  // Update form data when source or engagement type changes
  useEffect(() => {
  ...
  }, [formData.sourceType, formData.engagementType]);
  ...
  const engagementConfig = ENGAGEMENT_TYPE_CONFIGS[formData.engagementType];
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
              ...
              Contractor Calculation Inputs
            </CardTitle>
            <CardDescription>
              Configure the parameters for 1099/C2C contractor margin calculation
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: CandidateEngagementType) => handleInputChange('engagementType', value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              ...
              <Input
                id="companySplit"
                type="number"
                value={formData.companySplitPercent || 80}
                onChange={(e) => handleInputChange('companySplitPercent', parseFloat(e.target.value) || 0)}
                placeholder="80"
              />
              <p className="text-sm text-muted-foreground mt-1">
                Percentage of available margin that goes to the company
              </p>
            </div>
            ...
            {/* Special Notes for C2C */}
            {formData.engagementType === 'c2c' && (
              <div className="p-4 bg-blue-50 rounded-lg">
                <h4 className="font-medium text-blue-900 mb-2">C2C Considerations</h4>
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• No employer taxes required</li>
                  <li>• Candidate handles their own taxes and benefits</li>
                  <li>• Typically higher hourly rates to compensate</li>
                  <li>• Reduced administrative overhead</li>
                </ul>
              </div>
            )}

            {/* Special Notes for 1099 */}
            {formData.engagementType === '1099' && (
              <div className="p-4 bg-purple-50 rounded-lg">
                <h4 className="font-medium text-purple-900 mb-2">1099 Considerations</h4>
                <ul className="text-sm text-purple-800 space-y-1">
                  <li>• No employer taxes or benefits</li>
                  <li>• Candidate is responsible for self-employment taxes</li>
                  <li>• More flexibility in work arrangements</li>
                  <li>• Requires careful classification compliance</li>
                </ul>
              </div>
            )}
          </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  ...
                  Contractor Calculation Results
                </CardTitle>
                <CardDescription>
                  Margin calculation for {engagementConfig.label} contractor
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-4 bg-muted rounded-lg">
                    <div className="text-2xl font-bold text-green-600">
                      {formatCurrency(results.candidateRate)}/hr
                    </div>
                    <div className="text-sm text-muted-foreground">Contractor Rate</div>
                  </div>
                  {canViewAllMargins && (
                    <>
                      <div className="text-center p-4 bg-muted rounded-lg">
                ...
                <div className="mt-4 p-4 bg-green-50 rounded-lg">
                  <h4 className="font-medium text-green-900 mb-2">Tax Benefits</h4>
                  <div className="text-sm text-green-800">
                    <p>✓ No employer taxes required ({formData.employerTaxPercent}% savings)</p>
                    <p>✓ No benefits overhead</p>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center text-blue-600">
                      <span>- Company Share ({formData.companySplitPercent}%)</span>
                      <span className="font-medium">-{formatCurrency(results.breakdown.companyShare)}/hr</span>
                    </div>
                    <div className="flex justify-between items-center text-green-600">
                      <span>✓ No Employer Tax (0%)</span>
                      <span className="font-medium">$0.00/hr</span>
                    </div>
                    <div className="flex justify-between items-center text-red-600">
...
export default ContractorMarginCalculator;
